    ...
    <x-modal status="{{ $modal }}" title="Add Organization">
        <form wire:submit.prevent="store">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Address</label>
                    <textarea class="form-control @error('address') is-invalid @enderror" wire:model.defer="address" rows="3" required></textarea>
        ...
        @if (empty($organization))
            <div class="card-body">
                ...
                <div class="d-flex mb-2">
                    <input type="text" class="form-control rounded-pill mr-2"
        ...
        @else
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    A notification has been sent to the administrator.<br>
                    Wait for approval or <button class="btn btn-link p-0" wire:click.prevent="remove_org">undo</button> to change.</p>
                </div>
